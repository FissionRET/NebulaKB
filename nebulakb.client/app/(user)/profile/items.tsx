                    ...
                    <form className="grid grid-cols-2 gap-4">
                        ...
                        <div className="grid max-w-md gap-2">
                            ...
                            <Input type="text" id="role"
                                   defaultValue={userData.user.role === 0 ? "Khách hàng" : userData.user.role === 1 ? "Nhân viên" : userData.user.role === 3 ? "Quản trị viên" : 'Khách hàng'}
                                   readOnly/>
                        </div>
                        ...
                        <div className="grid max-w-md gap-2">
                            ...
                            <Input type="text" id="status"
                                   defaultValue={userData.user.status === 0 ? 'Hoạt động' : userData.user.status === 1 ? 'Bị cấm' : 'Hoạt động'}
                                   readOnly/>
                        </div>
                    </form>
                </CardContent>
                    ...
                    <form className="grid grid-cols-2 gap-4">
                        ...
                        <div className="grid max-w-md gap-2">
                            ...
                            <Input type="text" id="rank"
                                   defaultValue={userData.customer.rank === 0 ? 'Thành viên' : userData.customer.rank === 1 ? 'VIP' : 'Thành viên'}
                                   readOnly/>
                        </div>
