    ...
    return (
        ...
        >
                ...
                <p className="text-sm text-muted-foreground">
                    ...
                    <Tooltip color="default" content="Trạng thái hệ thống: Online" placement="right">
                        <span className="ml-2 relative h-3 w-3">
                            <span
                                className="animate-[ping_3s_ease-in-out_infinite] absolute inline-block h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
            ...
            <div className="flex h-5 items-center space-x-4 text-sm">
                ...
                <Link href="/shipping-policy" className={buttonVariants({variant: "outline"})}>Chính sách vận
                    chuyển</Link>
